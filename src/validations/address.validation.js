...
// --- 1. Schema cho việc TẠO MỚI địa chỉ (Tất cả các trường là BẮT BUỘC) ---
const createAddressValidation = Joi.object({
  ...
  type: Joi.string() // Chỉ chấp nhận các giá trị định sẵn.
    .valid(...ADDRESS_TYPES)
    .required()
    .messages({
  ...
  location: Joi.object({
    // Cấu hình chuẩn GeoJSON Point (MongoDB)
    ...
    .unknown(false) // Không cho phép các trường khác ngoài 'type' và 'coordinates'
    .required()
    .messages({
...
// --- 2. Schema cho việc CẬP NHẬT địa chỉ (Tất cả các trường đều là TÙY CHỌN) ---
const updateAddressValidation = createAddressValidation.optional();
